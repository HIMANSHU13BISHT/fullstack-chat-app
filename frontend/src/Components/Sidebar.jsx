...
const Sidebar = () => {
  const { getUsers, selectedUser, setSelectedUser, isUserLoading, users } = useChatStore();

  const {onlineUsers=[]}= useAuthStore(); // Update this with actual online user list logic
